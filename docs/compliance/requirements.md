...
| [DK-VAT-NON-DEDUCTIBLE-001](../../rules/dk/vat.yaml#L241) | § 37, stk. 1 | En ikke-momsregistreret virksomhed kan ikke fradrage købsmoms — `non_deductible` bogfører bilaget brutto på udgiftskontoen og skriver ingen 4000-linje. | [`src/core/expense-booking.ts:8`](../../src/core/expense-booking.ts#L8) | kode | — |

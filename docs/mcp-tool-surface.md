...
**Alle 105 tools deklarerer et `outputSchema`** (#202). Det er det samme
...
45 tools (tæl tabellen — den er facit). Bogfører i den append-only hash-kæde eller skriver

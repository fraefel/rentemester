...
const capabilityTuples: CapabilityTuple[] = [
  ...
  ["non-cash-balance-corrections", "Non-cash balance corrections", "Record one hash-bound DKK correction between eligible balance accounts.", "ledger", ["correct balance without bank movement", "non-cash balance correction", "internal balance voucher"], ["balance correction", "internal voucher", "no bank movement", "DKK"], "company", ["non-cash-balance-correction"]],

...
export const accrualSpecs: CommandSpec[] = [
  {
    ...
    inputNotes: [
      ...
      "--balance-account: balancekontoen beløbet parkeres på; defaulter pr. type (1300 / 7300 / 7310). --settlement-account: betalingskonto på modposten (standard er den bekræftede bankrolle).",
  ...
  },
  {
    ...
    inputNotes: [
      ...
      "--settlement-account: kun brugt af accrued_expense (afviklingen krediterer den bekræftede bankrolle som standard).",

...
export const documentsSpecs: CommandSpec[] = [
  ...
  { key: "documents parse-pending", usage: "documents parse-pending --company <path> --confirm yes [--limit <n>]", description: "Parser op til 100 gemte PDF-bilag uden en aktuel parse.", allowedFlags: ["--company", "--confirm", "--limit"] },

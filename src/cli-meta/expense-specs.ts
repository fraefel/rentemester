...
export const expenseSpecs: CommandSpec[] = [
  {
    key: "expense book",
    usage:
      "expense book --company <path> --document-id <n> --bank-transaction-id <n> --expense-account <konto> [--vat-treatment standard|reverse_charge|representation|exempt|non_deductible_full] [--payment-account <konto>] [--date <YYYY-MM-DD>] [--text <tekst>]",
    ...
    inputNotes: [
      ...
      "  non_deductible_full = bilag med moms hos en IKKE-momsregistreret virksomhed (§ 37): hele bilaget bogføres brutto på udgiftskontoen, ingen 4000 Købsmoms-linje, momsen indgår i kostprisen. Afvises for momsregistrerede selskaber — brug 'standard' der.",

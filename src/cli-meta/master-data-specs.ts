...
export const masterDataSpecs: CommandSpec[] = [
  ...
  { key: "vendor create", usage: "vendor create --company <path> --name <text> [--address <text>] [--cvr <id>] [--country <ISO>] [--identifier-kind <dk_cvr|eu_vat|non_eu>] [--expense-account <konto>] [--default-vat <text>] [--notes <text>] [--from-cvr <DK...>]", description: "Opretter en append-only leverandørpost til bilagsindlæsning. Ikke-EU-leverandører angives med --country og --identifier-kind non_eu og behøver ikke CVR/momsnummer. Med --from-cvr udfyldes navn/adresse/CVR automatisk fra CVR-registret.", allowedFlags: ["--company", "--name", "--address", "--cvr", "--country", "--identifier-kind", "--expense-account", "--default-vat", "--notes", "--from-cvr"] },

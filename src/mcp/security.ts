...
export const MCP_TOOL_PERMISSIONS: Readonly<Record<string, RoutePermission>> = Object.freeze(Object.fromEntries([
  ...
  ..."bookkeeping_batch_approve dimension_assignment_replace dimension_assignment_supersede exception_resolve period_close period_close_review posting_rule_approve".split(" ").map((n) => [n, "company.review"]),

...
function fixture() {
  ...
  db.query("INSERT INTO documents(document_no,source,original_filename,mime_type,status,stored_path,sha256_hash) VALUES(?,?,?,?,?,?,?)").run("D-1","test","evidence.pdf","application/pdf","stored","evidence.pdf",sourceHash);
